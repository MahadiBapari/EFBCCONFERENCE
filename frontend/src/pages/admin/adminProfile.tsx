...
export const AdminProfile: React.FC<AdminProfileProps> = ({ user, onUpdateProfile }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await onUpdateProfile({ name, email: formData.email });
    ...
    <div className="container">
      ...
      <div className="card profile-form">
        ...
        {isEditing ? (
          <form onSubmit={handleSubmit}>
            ...
            {profileMsg && (
              <div className={profileMsg.includes('success') ? 'success-message' : 'error-message'}>
                {profileMsg}
              </div>
            )}
            <div className="profile-actions">
              <button type="button" className="btn btn-secondary" onClick={handleCancel} disabled={profileLoading}>
                Cancel
              </button>
      ...
      <div className="card profile-form">
        ...
        <form onSubmit={handlePasswordChange}>
          ...
          {pwMsg && (
            <div className={pwMsg.includes('success') ? 'success-message' : 'error-message'}>
              {pwMsg}
            </div>
          )}
