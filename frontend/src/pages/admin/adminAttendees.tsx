                  ...
                  <tr key={`detail-${reg.id}`}>
                    ...
                    <td style={{ width: `${columnWidths.paymentMethod}px`, minWidth: `${columnWidths.paymentMethod}px` }}>
                      {(() => {
                        ...
                        // - Not paid
                        // - Has a total price > 0 (registration has a cost)
                        const hasMainPaymentDue = reg.paymentMethod === 'Card' && !(reg as any).paid && (reg.totalPrice || 0) > 0;
                        
                        // Spouse payment is due only if:
